...
export function generate() {
  ...
  switch (sign1) {
    case 1: op1 = "+"; break;
    case 2: op1 = "-"; break;
    case 3: op1 = "\\times"; break;
    case 4: op1 = "\\div"; break;
  }
  switch (sign2) {
    case 1: op2 = "+"; break;
    case 2: op2 = "-"; break;
    case 3: op2 = "\\times"; break;
    case 4: op2 = "\\div"; break;
  }
  ...
  do {
    ...
    sumq += "Calculate, without using a calculator, giving your answer in its simplest form. Show all your working.";
  ...
  const notesLink = "images/20200427-MathsBook1BasicNumv1_3-APO.pdf#page=22";
