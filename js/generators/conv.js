...
export function generate() {
  ...
  recentIds = QLimitRepeats(recentIds, 7);
  ...
  switch (sum) {
    ...
    case 7:
      ...
      let sel = rndgen(0, 15, 0, 1, -1);      //Selects row of qdata to use for question
      let qty = rndgen(qdata[sel][2], qdata[sel][3], 0, 1, -1);
      let rd = rndgen(0.78, 0.82, 2, 0.01, -1);
