// js/generators/transposeI.js
import * as utils from '../utils.js';

let sumarrtranspose1 = [];

export function generate() {
  let sumq = "", suma = "";

  sumarrtranspose1 = utils.QLimitRepeats(sumarrtranspose1, 33);
  const sum = sumarrtranspose1[sumarrtranspose1.length - 1];
  ...
  switch (sum) {
        ...
        case 33:
            ...
            break;
    default:
      sumq = "Transpose the following (case " + sum + ")";
      suma = "$$Solution coming$$";
  }

  const notesLink = "images/20200504-MathsBook5AlgebraicOpsv1_3-APO.pdf#page=29";
